    ...
    return (
            <div>   
                <div className={s.ProductLayout}>
                    <img className={s.img} src={`${`${BASE_URL + product[0]?.image}`}`}></img>
                    <div className={s.ProductInfoField}>
                        ...
                        <div className={s.ProductCostField}>
                            <div className={s.ProductCostField_Into}>
                                ...
                                {product[0]?.discont_price && <div className={s.ProductCost_Old}>
                                    {'$' + (product.price)}
                                </div>}
                            </div>
                            {product[0]?.discont_price && <div className={s.DiscountPercent}>
